...
export default function PurchaseEditView({ urlData }) {
        ...
        <Container maxWidth={settings.themeStretch ? false : 'lg'}>
            <CustomBreadcrumbs
                ...
                links={[
                    ...
                    { name: "Clients", href: paths.dashboard.PurchasePage.root },
                    { name: "Edit", },
                ]}
                sx={{ mb: { xs: 3, md: 5 } }}
            />
            ...
            {(selectedBooking !== null ) && <PurchaseEdit selectedBooking={selectedBooking}  urlData={urlData} />}
